...
execute if score @s grue.darknesstimer matches 260 run function nycto:player/warn

execute if score @s grue.darknesstimer matches 260 run effect give @s darkness 2 4 true
